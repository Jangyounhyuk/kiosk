            ...
            switch (mainSelect) {
                case "1":
                    ...
                    while (burgerMenu) {
                        ...
                        if (burgerSelect == 0) {
                            burgerMenu = !burgerMenu;
                        //이외 숫자 입력 시 주의문구
                        } else if (burgerSelect < 0 || burgerSelect > menu.burgerMenuItems.size()) {
                ...
                case "2":
                    ...
                    while (drinkMenu) {
                        ...
                        if (drinkSelect == 0) {
                            drinkMenu = !drinkMenu;
                        } else if (drinkSelect < 0 || drinkSelect > menu.drinkMenuItems.size()) {
                            System.out.println("메뉴에 있는 번호를 입력해주세요.");
                        } else {
                ...
                case "3":
                    ...
                    while (dessertMenu) {
                        ...
                        if (dessertSelect == 0) {
                            dessertMenu = !dessertMenu;
                        } else if (dessertSelect < 0 || dessertSelect > menu.dessertMenuItems.size()) {
                            System.out.println("메뉴에 있는 번호를 입력해주세요.");
                        } else {
